...
public class RobotContainer {
  // joystick
  private final CommandXboxController controller = new CommandXboxController(Constants.Xbox.CONTROLLER_PORT);
  // subsystems
  ...
  private void configureButtonBindings() {
    ...
    controller.povDown().onTrue(new InstantCommand(shooterSubsystem::decreaseFlywheelRPM, shooterSubsystem));
  }
